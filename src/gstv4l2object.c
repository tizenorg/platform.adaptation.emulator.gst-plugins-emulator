...
#include "ext/trash/gstv4l2tuner.h"
#include "ext/trash/gstv4l2colorbalance.h"
#include "ext/trash/gst/gstelement.h"

#include "ext/trash/gst-libs/gst/gst-i18n-plugin.h"
...
gst_v4l2_object_setup_pool (GstV4l2Object * v4l2object, GstCaps * caps)
{
 ...
 // GST_V4L2_CHECK_OPEN (v4l2object);
  if (v4l2object->video_fd <= 0 ) {
    GST_INFO ("Failed to open video fd in setup pool");
	return FALSE;
  }
